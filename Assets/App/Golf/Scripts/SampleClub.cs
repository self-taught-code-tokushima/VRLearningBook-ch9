...
{
    public class SampleClub : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            var stageIndex = ballRigidbody.GetComponent<SampleBall>().StageIndex;
            FindFirstObjectByType<SamplePauseHUD>().AddScore(stageIndex);
