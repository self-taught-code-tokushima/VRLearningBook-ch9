...
{
    public class SimpleSlideManager : MonoBehaviour
    {
        bool isGrabbed;
        ...
        void Update()
        {
            ...
            if (GetSlidePullBack() && !isGrabbed)
            {
                ...
                SlideBody.transform.localPosition = new Vector3(0, 0, DistanceLimitNegative) + VirtualAnchor.transform.localPosition;
            }
        ...
        void GrabUpdate()
        {
            ...
            Debug.Log($"slideBody.transform.localPosition: {SlideBody.transform.localPosition}, WorldPos: {SlideBody.transform.position}");
