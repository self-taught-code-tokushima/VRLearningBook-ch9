    ...
    public class SocketDetection : MonoBehaviour
    {
        ...
        public void SendSocketInfo()
        {
            ...
            if (GunManager != null && socketObject != null)
            {
                ...
                // 効果音を再生する
                if (Audio_SetMagazine != null)
                {
                    Audio_SetMagazine.transform.position = gameObject.transform.position;
                    Audio_SetMagazine.Play();
                }
                else
                {
                    Debug.Log("効果音SetMagazineはnull");
                }
            }
        ...
        public void ResetSocketInfo()
        {
            ...
            // 効果音を再生
            if (Audio_EjectMagazine != null)
            {
                Audio_EjectMagazine.transform.position = gameObject.transform.position;
                Audio_EjectMagazine.Play();
            }
            else
            {
                Debug.Log("効果音EjectMagazineがnull");
            }
